...
#==================================================================================================================
    ...
    all_data = pd.read_csv('Data/consolidatedDataForPackage.csv')
    metadata = pd.read_csv('Data/consolidatedMetadata.csv')
    hallData = pd.read_csv('Data/Hall/data_hall_raw.csv')
    gluVarProData = pd.read_csv('Data/Gluvarpro/Gluvarpro.csv')
    cgmData = pd.read_csv('Data/CGM/CGManalyzer.csv')
    ohioData = pd.read_csv('Data/Ohio-Data/OhioFullConsolidated.csv')
